...
function App() {
  ...
  function result(){
    ...
    if(resultCalc <= 0.7){
      alert("O etanol está " + resultCalc +"% do valor da gasolina. É mais vantajoso abastecer com etanol.")
    } else {
      alert("O etanol está " + resultCalc +"% do valor da gasolina. É mais vantajoso abastecer com gasolina.")
    }
  }
